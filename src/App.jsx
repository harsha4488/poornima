    ...
    <div className="app">
      ...
      <header className={scrolled ? "header scrolled" : "header"}>
        <a href="#home" className="brand" aria-label="Poornima Jewellers">
          <img className="brand-logo" src="/branding/poornima-logo.jpg" alt="Poornima Jewellers" />
        </a>
      ...
      <footer className="footer">
        <div>
          <img className="footer-logo" src="/branding/poornima-logo.jpg" alt="Poornima Jewellers" />
